...
export const MACARON_PALETTE: MacaronColor[] = [
  { name: 'peach',      light: '#FFE4D3', dark: '#F5B997', solid: '#FACAA8', ink: '#8C4D2C' },
  { name: 'mint',       light: '#DCF1E3', dark: '#9BD7B4', solid: '#B6E2C5', ink: '#316B4C' },
  { name: 'lavender',   light: '#E7DEF6', dark: '#BFA8E8', solid: '#D4C3F0', ink: '#553883' },
  { name: 'rose',       light: '#FBD9DE', dark: '#F2ABB6', solid: '#F6C2CA', ink: '#883B4B' },
  { name: 'sky',        light: '#DBECF6', dark: '#A7CEE5', solid: '#BFDBED', ink: '#355F7D' },
  { name: 'lemon',      light: '#FFF2C7', dark: '#F3D672', solid: '#F9E296', ink: '#8A6A1E' },
  { name: 'pistachio',  light: '#E4EFCD', dark: '#B9D8A0', solid: '#CDE3B3', ink: '#4C6E2A' },
  { name: 'periwinkle', light: '#DDE0F4', dark: '#B4B8E4', solid: '#C6CAEB', ink: '#3E4487' },
  { name: 'apricot',    light: '#FFE8C9', dark: '#F5C57E', solid: '#F8D49B', ink: '#7E5220' },
  { name: 'blueberry',  light: '#D7DEF1', dark: '#9AA8DC', solid: '#B7C0E6', ink: '#333C76' },
];
